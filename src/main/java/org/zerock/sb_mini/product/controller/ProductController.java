...
public class ProductController {
    ...
    //등록
    @PostMapping("add")
    public ResponseEntity<Long> add(@RequestBody ProductAddDTO dto) { // JSON을 자동으로 파싱해서 ProductAddDTO 객체에 담아줌
    ...
    public ResponseEntity<Void> modify(@PathVariable long pno, @RequestBody ProductModifyDTO dto) {
